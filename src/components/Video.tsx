  ...
  return (
    <div className="flex-1">
      <div className="bg-black flex justify-center">
        <div className="h-full w-full max-w-[1100px] max-h-[60vh] aspect-video border border-gray-100"></div>
      </div>
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              <div className="leading-relaxed">
                <strong className="font-bold text-2xl block">Antonio Silva</strong>
